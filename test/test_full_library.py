...
class TestSystem(TestCase):
    def test_sys_whole_library(self):
        ...
        self.assertEqual(
            t, count[0],
            "expected {} items excluding shared albums".format(t)
        )
        ...
        self.assertEqual(
            t, count[0],
            'expected {} total album count'.format(t)
        )
