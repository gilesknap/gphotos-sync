...
class LocationExtract:
    def __init__(self, with_gui: bool = False):
        ...
        self.cookie_file: Path = Path(app_dirs.user_cache_dir) / ".gphotos_cookies"
    ...
    def authenticate(self, url: str):
        ...
        self.driver.get(url)
        if str(self.driver.current_url).startswith("https://accounts.google.com"):
            ...
            while self.driver.current_url != url:
                sleep(1)
        pickle.dump(self.driver.get_cookies(), open(str(self.cookie_file), "wb"))
