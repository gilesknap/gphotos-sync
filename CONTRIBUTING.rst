...
.. _GitHub: https://github.com/dls-controls/gphotos-sync/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/gphotos-sync.git
    $ cd gphotos-sync
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/dls-controls/gphotos-sync/releases
